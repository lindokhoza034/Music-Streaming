    ...
    var e = "active",
        ...
        a = function (a, r) {
            ...
            l.show().animate({
                ...
                "success" === t && 200 == a.status && (e = $("<div>" + e + "</div>"), $("head title").html(e.find("title").html()), $("#wrapper").html(e.find("#wrapper").html()), $("html, body").animate({
                    scrollTop: 0
                }, 100), n(), i(), Dashboard.init())
            })).fail((function () {
                window.location.href = "404.html"
            })).always((function () {
                r && r.length && $(window).width() < 992 && ($(".sidebar-toggler").toggleClass(e), t.removeAttr("data-sidebar-toggle")), l.animate({
                    width: "100%"
        ...
        n = function () {
            ...
            if ($('[data-scroll="true"]').each((function () {
                    ...
                    class: a
                }), n = $(".mat-tabs"), r = $(".nav-link"), n.each((function () {
    ...
    return {
        init: function () {
            $("#loader").fadeOut(1e3), t.settings(), n(), $(window).on("popstate", (function () {
                ...
                e && a(e)
            })), $(document).on("click", 'aaaaaaaa', (function (e) {
            ...
            $("#player").addClass("show"), Amplitude.getSongs() && 1 === Amplitude.getSongs().length && (Amplitude.pause(), l((() => {
                ...
                callbacks: {
                    song_change: function () {
                        console.log(Amplitude.getAudio().src);
                        l((() => {
    ...
    return {
        ...
        init: function () {
            ...
            ! function () {
                ...
                var e = s(this); - 1 === i.findIndex((t => t.id === e.id)) ? (i.push(e), 1 === i.length ? o() : a.append(u(e))) : Utils.showMessage("Song already in Queue"), Utils.setLocalItem("songs", i)
